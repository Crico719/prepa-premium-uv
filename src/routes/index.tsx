...
const dailyTips = [
  ...
  "No compar tu progreso con el de otros. Cada uno tiene su ritmo.",
      ...
      <div className="grid gap-8 lg:grid-cols-[minmax(0,1.6fr)_minmax(0,1fr)]">
        <section className="space-y-8">
              ...
              <div className="grid gap-3 sm:grid-cols-3">
                {weakCourses.map((course) => (
                  <Link
                    ...
                    to="/cursos/$slug"
                    params={{ slug: course.slug }}
                    className="surface hover-lift press p-4"
                  >
                    ...
                    <div className="h-2 w-full overflow-hidden rounded-full bg-muted">
                      <span
                        className="block h-full rounded-full bg-destructive transition-all duration-500"
                        style={{ width: `${course.progress}%` }}
                      />
                    </div>
                    <p className="mt-2 text-xs text-muted-foreground">
                      Te quedan {course.hoursLeft}h de contenido
                    </p>
                  </Link>
                ))}
              </div>
          ...
          <div>
            <SectionHeader
              ...
              subtitle="Horas invertidas en aprender"
            />
                ...
                {weeklyStudy.map((d) => (
                  <div key={d.day} className="flex flex-1 flex-col items-center gap-1">
                    ...
                    <div
                      ...
                      style={{ height: `${(d.horas / maxHours) * 100}%`, minHeight: "4px" }}
                    />
        ...
        <aside className="space-y-6">
          ...
          <Surface className="overflow-hidden border-none bg-gradient-to-br from-primary/10 via-primary/5 to-transparent p-0">
            <div className="p-5">
              ...
              <p className="text-sm text-muted-foreground">
                ¿Tienes dudas? Pregúntale a PrepaBot sobre cualquier materia.
              </p>
              <Link
                to="/asistente"
                className="press mt-4 inline-flex min-h-10 items-center gap-2 rounded-[14px] bg-primary px-4 text-sm font-semibold text-primary-foreground"
              >
          ...
          <Surface className="flex flex-col items-center gap-4 text-center">
            ...
            <p className="text-sm text-muted-foreground">
              Has completado {student.xp} de {student.xpGoal} XP de tu plan.
            </p>
          </Surface>
